...
Select delegated skills in the parent, include `CAIRN_SKILL_IDS: <ids>` in each Task prompt, incorporate the result, then review every delegated skill id in the parent.
