// Live proof of steps 1-5: spawn a cairn-connected Claude (local CLI, no API key) that reads a timestamped
// conversation and outputs the compacted timestamp|step|result table. Prints the system prompt too, so it
// can be monitored. Run: bun scripts/compact-live.ts
...
console.log("=== spawning cairn-connected claude (this calls the real CLI)... ===\n");
