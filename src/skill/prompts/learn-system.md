...
- Never add a step that spawns, delegates to, or requests an independent reviewer/subagent unless the original user task explicitly requires delegation. Reviewer spawning is not a default quality method and can interfere with external harnesses or user-defined skills.
